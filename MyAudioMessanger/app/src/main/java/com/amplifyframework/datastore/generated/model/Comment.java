...
public final class Comment implements Model {
  ...
  public static final QueryField NAME = field("Comment", "name");
  public static final QueryField PRIORITY = field("Comment", "priority");
  ...
  private Comment(String id, String name, Priority priority, String message) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), comment.getId()) &&
              ...
              ObjectsCompat.equals(getPriority(), comment.getPriority()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, Priority priority, String message) {
      super.id(id);
      super.name(name)
        .priority(priority)
        .message(message);

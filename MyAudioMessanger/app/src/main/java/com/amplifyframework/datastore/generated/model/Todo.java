...
public final class Todo implements Model {
  ...
  public static final QueryField TIME = field("Todo", "time");
  ...
  private Todo(String id, String name, Priority priority, String description, String time) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), todo.getId()) &&
              ...
              ObjectsCompat.equals(getTime(), todo.getTime()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, Priority priority, String description, String time) {
      super.id(id);
      super.name(name)
        .priority(priority)
